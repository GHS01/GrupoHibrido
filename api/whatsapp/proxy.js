 ...
 * 
 * Este endpoint actúa como intermediario entre el frontend y Evolution API
 * para evitar problemas de CORS.
 */

import { getEvolutionApiUrl, getEvolutionApiInstance, getEvolutionApiToken } from '../../evolutionApiConfig';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const evolutionApiInstance = getEvolutionApiInstance();
